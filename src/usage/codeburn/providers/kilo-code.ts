...
import { discoverClineTasks, createClineParser, clineTaskRoots } from './vscode-cline-parser.ts'
import { discoverSqliteSessions, createSqliteSessionParser, type SqliteProviderConfig } from './sqlite-session-parser.ts'
import type { ProbeRoot, Provider, SessionSource, SessionParser } from './types.ts'
