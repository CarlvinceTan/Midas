...
import { FS_SCAN_CONCURRENCY, mapWithConcurrency } from '../fs-utils.ts'
import type { ParsedProviderCall, ProbeRoot, Provider, SessionParser, SessionSource } from './types.ts'
...
export async function kimicodeLineageForSource(path: string, agentId: string): Promise<import('../types.ts').SessionLineage | undefined> {
